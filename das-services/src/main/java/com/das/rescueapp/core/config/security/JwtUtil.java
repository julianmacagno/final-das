...
//                authorities = ((List<String>) claims.get(CLAIM_KEY_AUTHORITIES)).stream().map(SimpleGrantedAuthority::new).toList();
//            }
    ...
    public String generateToken(JwtUser userDetails) {
        ...
        claims.put(CLAIM_KEY_USERNAME, userDetails.getUser().getCuil());
        claims.put(CLAIM_KEY_NAME, userDetails.getUser().getName());
//        claims.put(CLAIM_KEY_SURNAME, userDetails.getUser().getSurname());
        claims.put(CLAIM_KEY_CUIL, userDetails.getUser().getCuil());
        claims.put(CLAIM_KEY_CREATED, new Date());
//        List<String> auth = userDetails.getAuthorities().stream().map(GrantedAuthority::getAuthority).toList();
        claims.put(CLAIM_KEY_USER_ID, userDetails.getUser().getId());
